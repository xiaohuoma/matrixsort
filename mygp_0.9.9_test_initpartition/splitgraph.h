...
void SplitGraphReorder(graph_t *graph, graph_t **sub_lgraph, graph_t **sub_rgraph)
{
    ...
    //cmap --> rename
    rename = graph->cmap;
    // rename = (Hunyuan_int_t *)check_malloc(sizeof(Hunyuan_int_t) * nvtxs, "SplitGraphoRerder: rename");
    ...
    lgraph = SetupSplitGraph(lgraph, subnvtxs[0], subnedges[0]);
    ...
    rgraph = SetupSplitGraph(rgraph, subnvtxs[1], subnedges[1]);
    ...
    *sub_rgraph = rgraph;
    ...
    // check_free(rename,"SplitGraphReorder: rename");
...
void SplitGraphPartition(graph_t *graph, graph_t **sub_lgraph, graph_t **sub_rgraph)
{
    Hunyuan_int_t nvtxs, nbnd;
    Hunyuan_int_t *xadj, *vwgt, *adjncy, *adjwgt, *label, *where;
    Hunyuan_int_t subnvtxs[2], subnedges[2];
    Hunyuan_int_t *subxadj[2], *subvwgt[2], *subadjncy[2], *subadjwgt[2], *sublabel[2];
    Hunyuan_int_t *rename;
    graph_t *lgraph, *rgraph;
    ...
    subnvtxs[0]  = subnvtxs[1] = 0;
    subnedges[0] = subnedges[1] = 0;

    //cmap --> rename
    // rename = graph->cmap;
    rename = (Hunyuan_int_t *)check_malloc(sizeof(Hunyuan_int_t) * nvtxs, "SplitGraphPartition: rename");
