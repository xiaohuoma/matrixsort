...
typedef struct cnbr_t {
  Hunyuan_int_t pid;            /*!< The partition ID */
  Hunyuan_int_t ed;             /*!< The sum of the weights of the adjacent edges
...
typedef struct graph_t 
{
	...
	cnbr_t *cnbr;				/*!< cnbrpool*/
	Hunyuan_int_t cnbr_size;	/*!< nbrpoolsize*/
	Hunyuan_int_t cnbr_length;	/*!< nbrpoolcpos*/
	Hunyuan_int_t cnb_reallocs;	/*!< nbrpoolreallocs*/
...
typedef struct ctrl_t 
{
	...
	double pfactor;		/* .1*(user-supplied prunning factor) */

	double *ubfactors;            /*!< The per-constraHunyuan_int_t ubfactors */
	
	double *tpwgts;               /*!< The target partition weights */
	double *pijbm;                /*!< The nparts*ncon multiplies for the ith partition
										and jth constraHunyuan_int_t for obtaining the balance */

	double cfactor;               /*!< The achieved compression factor */
...
/*! binary heap node */
/*************************************************************************/
typedef struct node_real_t
{ 
	Hunyuan_real_t key;  //  ed - id
	Hunyuan_int_t val;  //  vertex
} node_real_t;
...
/*! Priority queue based on binary heap */
/*************************************************************************/
typedef struct priority_queue_real_t
{ 
	size_t nownodes; 
	size_t maxnodes; 
	node_real_t *heap; 
